'''
	...
	Usage:
		You place a file called Birthday_Dates in the root of the XBMC4kids directory ( Next to the default.xbe ) with a sructure like.
...
print "================================================================================"
print "| Scripts\XBMC4Kids\Utilities\Check Birthday Dates.py loaded."
print "| ------------------------------------------------------------------------------"

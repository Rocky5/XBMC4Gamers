...
def auto():
	xbmc.executebuiltin( "RunScript(" + intial_dir + "\\resources\\lib\\auto.py)" )
	
def manual():
	xbmc.executebuiltin( "RunScript(" + intial_dir + "\\resources\\lib\\manual.py)" )
	
def uninstall():
	xbmc.executebuiltin( "RunScript(" + intial_dir + "\\resources\\lib\\uninstall.py)" )

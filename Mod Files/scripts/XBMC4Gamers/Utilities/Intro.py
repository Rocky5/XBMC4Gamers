...
if filename.endswith(tuple(Extensions)):
	...
	if not isplayed or winPrograms:
		...
		if ReplaceWindowHome:
			...
			xbmc.executebuiltin( "RunScript( Special://xbmc/scripts/XBMC4Gamers/Utilities/Update Checker.py )" )
...
if not intro_found: xbmc.executebuiltin( "RunScript( Special://xbmc/scripts/XBMC4Gamers/Utilities/Update Checker.py )" )

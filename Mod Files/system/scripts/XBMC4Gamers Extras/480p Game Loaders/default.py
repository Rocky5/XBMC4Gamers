...
#####	Modules required
limpp	= xbmc.translatePath( "special://xbmc/system/scripts/.modules/script.module.limpp" )
xbeinfo	= xbmc.translatePath( "special://xbmc/system/scripts/.modules/script.module.xbeinfo" )

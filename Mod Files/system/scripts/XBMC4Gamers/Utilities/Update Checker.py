...
print "================================================================================"
print "| Scripts\XBMC4Gamers\Utilities\Update Checker.py loaded."
print "| ------------------------------------------------------------------------------"
...
if os.path.isfile( xbmc.translatePath( "special://xbmc/Updater/default.xbe" ) ):
	if os.path.isfile( xbmc.translatePath( "special://xbmc/Updater/update_complete" ) ):
		...
		if dialog.yesno( "XBMC4Gamers Updater","", "Update Folder found, would you like to install the update?","","Update Later","Update Now" ) == 1:
